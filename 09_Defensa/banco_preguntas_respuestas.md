# Banco de preguntas y respuestas - Defensa FabroGym 2B

## P1. ¿Cuál es el problema real que resuelve FabroGym?
Centraliza clientes, membresías, pagos, asistencia, inventario, caja y rutinas que antes se manejaban con notas, Excel, WhatsApp o revisión manual.

## P2. ¿Cuál fue el enfoque empírico?
Enfoque 3: explicabilidad como requisito no funcional, aplicado al dominio de recomendación de rutinas en un gimnasio local.

## P3. ¿El sistema ya implementa IA?
No. El componente de recomendación/IA está propuesto y especificado; no se declara como funcionalmente implementado.

## P4. ¿Cuántas sesiones de campo tienen?
Diez entrevistas ENTR-01 a ENTR-10 y seis walkthroughs: WALK-TEC-01..03 y WALK-NTEC-01..03.

## P5. ¿Por qué los WALK cuentan pero no se renombran como entrevistas?
...
## P8. ¿Por qué no calcularon Fleiss kappa?
No hubo dos rondas equivalentes de clasificación por evaluadores independientes. Inventarlo sería una mala práctica.

## P9. ¿La encuesta mide explicabilidad?
No. La encuesta se analiza como evidencia descriptiva del dominio; no se transforma en escala Likert de explicabilidad.

## P10. ¿La saturación cumple el 5 %?
Por códigos normalizados, no: 6.306 %. A nivel de categorías axiales se observa estabilización complementaria con 1.852 %.

## P11. ¿Qué aporta el member checking?
Valida con participantes previos la interpretación de los RNF; produjo 12 decisiones: 4 confirmaciones, 8 ajustes y 0 rechazos.

## P12. ¿Por qué no hay video de member checking?
