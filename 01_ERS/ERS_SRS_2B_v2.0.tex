...
\hypersetup{colorlinks=true,linkcolor=navy,urlcolor=teal,citecolor=navy,pdftitle={FabroGym ERS/SRS 2B v2.2},pdfauthor={Equipo FabroGym ISR-401}}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\small FabroGym -- ERS/SRS 2B}
\fancyhead[RO]{\small Entrega 4 (2B) -- v2.2}
...
\vspace{0.25cm}
{\Large\bfseries Entrega 4 (2B / Defensa Final) -- Versión 2.2\par}
\vspace{0.18cm}
...
Versión & 2.2 -- cierre técnico 2B con UML definitivo \\\hline
...
La versión 2.2 sustituye la ERS/SRS 2B v2.1 como especificación final de cierre de la Entrega 4. Mantiene el catálogo terminal y los resultados 2B, y reemplaza el anexo técnico heredado por el conjunto UML definitivo del equipo. Se integran 54 diagramas: contexto, casos de uso general e individuales, actividades, secuencias, estados, clases, componentes, despliegue e i*. El modelado se presenta como evidencia técnica vigente y se subordina a los 48 requisitos terminales, a la trazabilidad 2B y al estado real del MVP. No se inventan aprobaciones, firmas, SWHID, pruebas ni grabaciones inexistentes. El DOI Zenodo \texttt{10.5281/zenodo.22237884} fue reservado por el servicio Zenodo para el paquete final de replicación.
...
El catálogo canónico elimina IDs duplicados de versiones previas. Antes de incorporar explicabilidad contiene 44 IDs únicos (25 RF, 15 RNF y 4 RD); con los cuatro RNF-EXP derivados y revisados, la ERS 2B contiene \textbf{48 requisitos terminales}. Los requisitos de explicabilidad se agregan con IDs nuevos y no reciclan IDs históricos.

\subsection{Requisitos funcionales}
\subsubsection{RF-AUT-01 -- Garantizar tratamiento lícito y minimización de datos}
...
\subsubsection{RF-AUT-02 -- Controlar acceso por roles y permisos}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-AUT-03 -- Asegurar trazabilidad de eventos críticos}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
Estado & ESPECIFICADO; cobertura MVP se verifica en C3 \\ \hline
\end{tabularx}
\subsubsection{RF-CLI-01 -- Registrar datos mínimos de cliente}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-CLI-02 -- Consultar ficha de cliente}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-CLI-03 -- Actualizar y reactivar cliente}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-MEM-01 -- Configurar catálogo de planes}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-MEM-02 -- Activar y renovar membresía}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-PAG-02 -- Resolver pagos pendientes}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-INV-03 -- Alertar stock y rotación}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
Estado & ESPECIFICADO; cobertura MVP se verifica en C3 \\ \hline
\end{tabularx}
\subsubsection{RF-RUT-01 -- Administrar rutinas}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
\subsubsection{RF-RUT-02 -- Registrar seguimiento}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{3.2cm}|X|}\hline
...
RNF-ED-01 & Eficiencia de desempeño & Con 10 000 clientes sintéticos y 20 sesiones concurrentes, el percentil 95 de búsqueda y consulta de membresía será $\leq$ 5 s y la tasa de error $\leq$ 1 \%. & ISO/IEC 25010 \\ 
RNF-ED-02 & Eficiencia de desempeño & El registro de asistencia confirmada completará el flujo en $\leq$ 30 s para al menos 9 de 10 tareas de una prueba moderada. & ISO/IEC 25010 \\ 
...
RNF-FIA-01 & Fiabilidad & Tras 100 operaciones transaccionales de pago, venta y asistencia con una interrupción simulada, no habrá registros parciales y la recuperación será $\leq$ 10 min. & ISO/IEC 25010 \\ 
RNF-FIA-02 & Fiabilidad & Una copia diaria cifrada permitirá restaurar una base sintética de prueba con RPO $\leq$ 24 h y RTO $\leq$ 4 h en un simulacro documentado. & ISO/IEC 25010 / OWASP \\ 
...
RNF-MAN-01 & Mantenibilidad & La suite automatizada cubrirá $\geq$ 70 \% de líneas de los módulos de dominio antes de etiquetar una versión candidata. & ISO/IEC 25010 \\ 
...
\subsubsection{RNF-EXP-01 -- derivado de RNF-EXP-C01}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{4.0cm}|X|}\hline
...
\end{tabularx}
\subsubsection{RNF-EXP-02 -- derivado de RNF-EXP-C02}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{4.0cm}|X|}\hline
...
Estado & ESPECIFICADO \\ \hline
\end{tabularx}
\subsubsection{RNF-EXP-03 -- derivado de RNF-EXP-C03}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{4.0cm}|X|}\hline
...
Estado & ESPECIFICADO \\ \hline
\end{tabularx}
\subsubsection{RNF-EXP-04 -- derivado de RNF-EXP-C04}
\begin{tabularx}{\textwidth}{|>{\bfseries}p{4.0cm}|X|}\hline
...
RD-PRI-01 & Excluir datos reales de salud y biometría automatizada; usar minimización, seudonimización y datos sintéticos en diseño y pruebas. & LOPDP / SPDP \\ 
RD-PRI-02 & Aplicar privacidad desde el diseño y por defecto, mínimo privilegio y conservación limitada. & LOPDP / SPDP \\ 
RD-PRI-03 & Prever mecanismos trazables de acceso, rectificación, actualización, eliminación, oposición y portabilidad antes de producción. & LOPDP \\ 
...
\subsubsection{HU-01 / CU-01 / RF-AUT-01}
...
\subsubsection{HU-02 / CU-02 / RF-AUT-02}
...
\subsubsection{HU-03 / CU-03 / RF-CLI-01}
...
\subsubsection{HU-04 / CU-04 / RF-CLI-02}
...
\subsubsection{HU-05 / CU-05 / RF-CLI-03}
...
\subsubsection{HU-06 / CU-06 / RF-MEM-01}
...
\subsubsection{HU-07 / CU-07 / RF-MEM-02}
...
\subsubsection{HU-08 / CU-08 / RF-MEM-03}
...
\subsubsection{HU-09 / CU-09 / RF-MEM-04}
...
\subsubsection{HU-10 / CU-10 / RF-PAG-01}
...
\subsubsection{HU-11 / CU-11 / RF-ASI-01}
...
\subsubsection{HU-12 / CU-12 / RF-ASI-02}
...
\subsubsection{HU-13 / CU-13 / RF-INV-01}
...
\subsubsection{HU-14 / CU-14 / RF-INV-02}
...
\subsubsection{HU-15 / CU-15 / RF-VEN-01}
...
\subsubsection{HU-16 / CU-16 / RF-CAJ-01}
...
\subsubsection{HU-17 / CU-17 / RF-NOV-01}
...
\subsubsection{HU-18 / CU-18 / RF-RUT-01}
...
\subsubsection{HU-19 / CU-19 / RF-RUT-02}
...
El modelado de esta versión corresponde al conjunto UML definitivo del equipo y reemplaza las figuras de síntesis provisionales utilizadas en v2.0--v2.1. La carpeta fuente se conserva en \path{03_Modelado/Diagramas_UML/}. La revisión de integración comprobó correspondencia nominal entre los 19 casos de uso Must, sus diagramas individuales y los 19 diagramas de secuencia; los RF Should permanecen especificados y trazados aunque no tengan CU individual obligatorio.
...
El diseño terminal exige control por rol, denegación por defecto, expiración de sesión, protección de secretos y TLS en un despliegue conectado. Estos objetivos se verifican por RNF-SEG-01..03; no se confunden con las credenciales académicas simples del prototipo demostrativo \cite{owasp2025,nist2025}.
...
La matriz externa \texttt{04\_Trazabilidad/matriz\_trazabilidad\_2B.csv} contiene 97 filas cerradas. Cada fila relaciona fuente/ley, objetivo, stakeholder, evidencia, requisito, CU, HU, CA, componente y mockups. La figura resume el encadenamiento utilizado.
...
\end{riskbox}
\begin{riskbox}
\textbf{DOI Zenodo.} El paquete final de replicación está identificado mediante DOI Zenodo \href{https://doi.org/10.5281/zenodo.22237884}{10.5281/zenodo.22237884}. El identificador se incorporó de forma consistente en esta ERS, el README, CITATION.cff y el manuscrito.
\end{riskbox}
\begin{riskbox}
...
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_01_RF-AUT-01.png}
\caption{Secuencia de RF-AUT-01: Autenticar usuario.}\label{fig:ds-01}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_02_RF-AUT-02.png}
\caption{Secuencia de RF-AUT-02: Aplicar permisos por rol.}\label{fig:ds-02}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_03_RF-CLI-01.png}
\caption{Secuencia de RF-CLI-01: Registrar cliente mínimo.}\label{fig:ds-03}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_04_RF-CLI-02.png}
\caption{Secuencia de RF-CLI-02: Buscar y consultar cliente.}\label{fig:ds-04}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_05_RF-CLI-03.png}
\caption{Secuencia de RF-CLI-03: Actualizar o reactivar cliente.}\label{fig:ds-05}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_06_RF-MEM-01.png}
\caption{Secuencia de RF-MEM-01: Configurar planes y promociones.}\label{fig:ds-06}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_07_RF-MEM-02.png}
\caption{Secuencia de RF-MEM-02: Activar o renovar membresía.}\label{fig:ds-07}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_08_RF-MEM-03.png}
\caption{Secuencia de RF-MEM-03: Consultar vigencia.}\label{fig:ds-08}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_09_RF-MEM-04.png}
\caption{Secuencia de RF-MEM-04: Alertar vencimientos.}\label{fig:ds-09}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_10_RF-PAG-01.png}
\caption{Secuencia de RF-PAG-01: Registrar pago y comprobante.}\label{fig:ds-10}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_11_RF-ASI-01.png}
\caption{Secuencia de RF-ASI-01: Registrar asistencia.}\label{fig:ds-11}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_12_RF-ASI-02.png}
\caption{Secuencia de RF-ASI-02: Consultar asistencia.}\label{fig:ds-12}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_13_RF-INV-01.png}
\caption{Secuencia de RF-INV-01: Administrar productos.}\label{fig:ds-13}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_14_RF-INV-02.png}
\caption{Secuencia de RF-INV-02: Registrar movimientos de stock.}\label{fig:ds-14}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_15_RF-VEN-01.png}
\caption{Secuencia de RF-VEN-01: Registrar venta.}\label{fig:ds-15}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_16_RF-CAJ-01.png}
\caption{Secuencia de RF-CAJ-01: Cerrar turno y conciliar caja.}\label{fig:ds-16}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_17_RF-NOV-01.png}
\caption{Secuencia de RF-NOV-01: Gestionar novedades internas.}\label{fig:ds-17}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_18_RF-RUT-01.png}
\caption{Secuencia de RF-RUT-01: Crear y asignar rutina.}\label{fig:ds-18}
\end{figure}\end{landscape}
\begin{landscape}\begin{figure}[p]\centering
\includegraphics[width=.96\linewidth,height=.76\textheight,keepaspectratio]{04_Secuencia/DS_19_RF-RUT-02.png}
\caption{Secuencia de RF-RUT-02: Versionar y ajustar rutina.}\label{fig:ds-19}
\end{figure}\end{landscape}
